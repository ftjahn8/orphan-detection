...
|--------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|-------------------------------------|-------------------------------------|
| -s                       | Skips download phase and reuse already downloaded web archive data from a previous run, if this argument is set. (date has to be the date when the previous download run was done!) | date with the format YYYY-MM-DD                            | deactivated                         | -s 2022-06-26                       |
...
Example command for execution the detection with some arguments (with source code):  
 ```console
python main.py example.com -a -s 2022-06-26 --a_cpd_timeout 10 --a_lspd_timeout 10 --a_os_cutoff 0.9 
```

Example command for execution the detection with some arguments (with docker container):  
 ```console
docker run  -it --name my_detection --rm orphan-detection example.com -a -s 2022-06-26 --a_cpd_timeout 10 --a_lspd_timeout 10 --a_os_cutoff 0.9 
```
...
| Argument                 | Description                                                                                                                                                                                                                                                                                   | Accepted Values                 | Default Value | Example*                     |
|--------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|---------------|------------------------------|
| -a                       | REQUIRED! Activates the analysis process. Without this flag the detection process is started.                                                                                                                                                                                                 | -                               | deactivated   | -a                           |
| -s                       | REQUIRED! Reuses already downloaded web archive data from the previous detection run (date has to be the date when the previous download run was done!)                                                                                                                                       | date with the format YYYY-MM-DD | -             | -s 2022-06-26                |
